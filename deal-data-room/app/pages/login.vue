    ...
    <div class="login-card">
      ...
      <div class="login-logo">
        ...
        <div class="login-brand">
          <div class="login-brand-name">BRDB Berhad</div>
      ...
      <div class="nda-notice">
        ...
        <div class="nda-text">
          ...
          Non-Disclosure Agreement with BRDB Berhad and are authorised
      ...
      <div class="login-footer">
        Access issues? Contact your BRDB deal team administrator.
      </div>
